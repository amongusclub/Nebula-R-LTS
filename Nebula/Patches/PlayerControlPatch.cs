...
{
    public static bool Prefix(NetworkedPlayerInfo __instance, [HarmonyArgument(0)] byte playerId, [HarmonyArgument(1)] Il2CppStructArray<byte> taskTypeIds)
    {
...
public class PlayerControlPatch
{
    ...
    public static void UpdatePlayerVisibility(PlayerControl player)
    {
        ...
        if (player.cosmetics.colorBlindText != null)
            player.cosmetics.colorBlindText.color = data.TransColor;
